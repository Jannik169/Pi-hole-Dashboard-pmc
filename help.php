...
<div class="row">
    <div class="col-md-12">
    <h2>Allow / Block</h2>
    <p>Allow or block domains (or subdomains). If a domain is added to e.g. the allowed ones, any possible entry of the same domain will be automatically removed from the blocklist and vice versa.</p>
    <p>Regex blocklisting is supported (entering <code>^example</code> will block any domain starting with <code>example</code>, see also our <a href="https://docs.pi-hole.net/ftldns/regex/" rel="noopener" target="_blank">Regex documentation</a>). You can still allow specific domains even if they fall under a regex pattern.</p>
